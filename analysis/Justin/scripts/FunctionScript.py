...
def LoadnClean (path):
    ...
    df3 = ( df2
                ...
                .assign(Avg_Outstanding (df2["Outstanding/Sept05"]+df2['Outstanding/Aug05']+df2['Outstanding/Jul05']
                                         +df2['Outstanding/Jun05']+df2['Outstanding/May05']+df2['Outstanding/Apr05'])/6)
